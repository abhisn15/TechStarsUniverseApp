    ...
    images: [
      {
        id: 1,
        logo: {
          uri: "https://solusiprinting.com/wp-content/uploads/2020/08/Logo-Gojek-1280px-x-720px-1024x576.jpg",
        },
        logo2: {
          uri: "https://solusiprinting.com/wp-content/uploads/2020/08/Logo-Garuda-Indonesia-1280px-x-720px-1024x576.jpg",
        },
        logo3: {
          uri: "https://magetan.satujam.com/wp-content/uploads/2015/10/logo-pepsi.jpg?strip=all&lossy=1&ssl=1",
        },
        logo4: {
          uri: "https://d1csarkz8obe9u.cloudfront.net/posterpreviews/alphabet-m-corporate-company-logo-design-template-0e933095f93292d183d46aed37cc8c3a_screen.jpg?ts=1615224021",
        },
        logo5: {
          uri: "https://static.republika.co.id/uploads/images/inpicture_slide/logo-x-yang-akan-menggantikan-logo-twitter-sebelumnya-berbagai_230725134138-520.png",
        },
      },
    ],
  },
...
export default function Network() {
  ...
  const snapPoints = useMemo(
    () => ["25%", Dimensions.get("screen").width > 360 ? "45%" : "47.5"],
    []
  );

  const snapPointsClck = useMemo(
    () => ["25%", Dimensions.get("screen").width > 360 ? "50%" : "60"],
    []
  );

  const toggleSelected = () => {
    setSelectedPlace(!selectedPlace);
    setSelectedDescription(false); // Menonaktifkan selectedDescription saat selectedPlace diaktifkan
  };

  const toggleSelectedDescription = () => {
    setSelectedDescription(!selectedDescription);
    setSelectedPlace(false); // Menonaktifkan selectedPlace saat selectedDescription diaktifkan
  };
  ...
  return (
    <View style={{ backgroundColor: "white" }}>
        ...
        >
          ...
          <TouchableOpacity>
            <Image
              style={{
                width: 20,
                marginLeft: Dimensions.get("screen").width > 360 ? 38 : 48,
              }}
      ...
      {selectedDescription && selectedPlace (
        <BottomSheet ref={bottomSheetRef} index={1} snapPoints={snapPointsClck}>
                  ...
                  data.id === 1 && (
                    <View style={{ height: "auto" }} key={data.id}>
                      <ImageBackground
                        ...
                        style={{
                          width:
                            Dimensions.get("screen").width > 360 ? 360 : "49%",
                          height: 120,
                          marginTop: 16,
                          marginHorizontal: 20,
                        }}
                      ...
                      <TouchableOpacity
                        style={[
                          styles.button,
                          { backgroundColor: "#39C463", marginTop: 36 },
                        ]}
                      >
      ...
      {!selectedPlace && !selectedDescription && (
        <BottomSheet ref={bottomSheetRef} index={1} snapPoints={snapPoints}>
          <View style={styles.container}>
            ...
            <Text style={{ fontSize: 14 }}>
              nearest accelerator from your current location
            </Text>
          </View>
          <ScrollView horizontal showsHorizontalScrollIndicator={false}>
            {Data.map((items) => (
              <TouchableOpacity
                onPress={toggleSelectedDescription}
                key={items.id}
                style={toggleSelected && selectedPlace}
              >
                <ImageBackground
                  source={items.bgimg}
                  resizeMode="cover"
                  style={{
                    ...
                    height: 162,
                    marginTop: 16,
                    marginRight: items.id != 0 ? 20 : 0,
                    marginLeft: items.id === 1 ? 20 : 0,
                  }}
                >
                  <View
                    style={{
